...
cv2.imwrite("/Users/bisma/Documents/GitHub/EC601_OpenCV/baboon/Thresholded.png", Thresholded)
...
cv2.imwrite("/Users/bisma/Documents/GitHub/EC601_OpenCV/baboon/Binary_threshold.png", BinaryThreshold)
...
cv2.imwrite("/Users/bisma/Documents/GitHub/EC601_OpenCV/baboon/Band_thresholding.png",BandThresholding)
...
cv2.imwrite("/Users/bisma/Documents/GitHub/EC601_OpenCV/baboon/Semi_thresholding.png",SemiThresholding)

# Adaptive thresholding
AdaptiveThreshold = cv2.adaptiveThreshold(gray, max_threshold, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 101, 10);
cv2.imwrite("/Users/bisma/Documents/GitHub/EC601_OpenCV/baboon/Adaptive_Threshold.png",AdaptiveThreshold)
